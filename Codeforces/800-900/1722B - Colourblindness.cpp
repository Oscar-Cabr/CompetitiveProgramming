/*
    The following is an original solution to the problem: 1722-B "Colourblindness" of Codeforces.
    Rated difficulty: 800. Language: C++20 (GCC 13-64).
    This solution isn't secured as "the most efficient one", but it is secured as an Accepted one under the given constraints.
    Techniques / Topics involved: Implementation, Adhoc.

    Check out the problem at: https://codeforces.com/contest/1722/problem/B
