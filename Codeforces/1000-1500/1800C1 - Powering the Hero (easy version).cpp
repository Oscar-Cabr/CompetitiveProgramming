/*
    The following is an original solution to the problem: 1800-C1 "Powering the Hero (easy version)" of Codeforces.
    ...
    Check out the problem at: https://codeforces.com/contest/1800/problem/C1
